...
void updateKeys(const int& c) {
    keysCRC[0] = (keysCRC[0] >> 8) ^ crc32Table[0][(keysCRC[0] ^ c) & 0xff];
    keysCRC[1] = (keysCRC[1] + (keysCRC[0] & 0xff)) * 134775813 + 1;
    keysCRC[2] = (keysCRC[2] >> 8) ^ crc32Table[0][(keysCRC[2] ^ (keysCRC[1] >> 24)) & 0xff];
}

void initKeys(char *password){
    keysCRC[0] = 0x12345678;
    keysCRC[1] = 0x23456789;
    keysCRC[2] = 0x34567890;
